                  ...
                  <div className="flex-1 min-w-0 relative">
                    ...
                    {currentUserId === comment.created_by_user_id && (
                      <button
                        ...
                        disabled={isPending}
                        className="absolute top-0 right-0 w-5 h-5 rounded bg-red-100 hover:bg-red-200 text-red-600 hover:text-red-700 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity disabled:opacity-50 cursor-pointer"
